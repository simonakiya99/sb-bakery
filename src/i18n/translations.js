export const translations = {
  ...
  ti: {
    ...
    hero_subtitle: 'ንፍሉይ እዋናትካ ዝኸውን ብኢድ ዝተዳለወ ምኡዝ ኬክ። ካብ ናይ መርዓ ኬክ ክሳብ ዘመናዊ ናይ ልደት ኬክ — ነፍሲ ወከፍ ስራሕ ፍሉይ እዩ።',
    ...
    about_title_post: '፡ ብውዕዉዕ ስምዒት ዝተሰንከተ',
    about_text1: 'SB ካብቲ ንምስንካት ኬክን ጥዑም መግቢታትን ዘሎኒ ዓሚቕ ፍቕሪ እዩ ተመስሪቱ። ነፍሲ ወከፍ ዝሰርሖ ኬክ — ካብቲ ዝበለጸ ክሳብቲ ንእሽቶ ዝርዝር ነገራት — ድንቂ ናይ ጥበብ ስራሕ እዩ።',
    about_text2: 'ብዙሓት ሕጉሳት ዓማዊል ኣለዉኒ። ኣብ ኩሉ ስራሓተይ ንጽሬትን ንውልቃዊ ድሌት ዓማዊልን ቀዳምነት እህብ።',
    ...
    courses_subtitle: 'ጥበብ ምስንካት ኬክ ተማሃር — ካብ መጀመርታ ክሳብ ላዕለዋይ ደረጃ፡ ብኣካል ወይ ብኢንተርነት።',
    ...
    // FOOTER
    footer_desc: 'ብኢድ ዝተዳለወ፡ ብፍቕርን ብውዕዉዕ ስምዒትን ዝተሰንከተ ምኡዝ ኬክ። ንነፍሲ ወከፍ ኣብ ህይወትካ ዘጋጥሙ ፍሉያት እዋናት።',
